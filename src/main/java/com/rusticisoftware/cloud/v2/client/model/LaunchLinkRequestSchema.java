...
public class LaunchLinkRequestSchema   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The URL the application should redirect to when the learner exits a course. If not specified, configured value will be used.")
