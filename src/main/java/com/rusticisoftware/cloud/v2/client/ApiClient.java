...
import com.rusticisoftware.cloud.v2.client.auth.Authentication;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("LAUNCH_TOKEN", new ApiKeyAuth("query", "launchToken"));
    authentications.put("OAUTH", new OAuth());
    authentications.put("URL_TOKEN", new ApiKeyAuth("query", "authtoken"));
