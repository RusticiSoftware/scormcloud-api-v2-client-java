...
public class PublicInvitationList {
  ...
  private List<PublicInvitationSchema> invitations = new ArrayList<PublicInvitationSchema>();
   ...
   * @return invitations
  **/
  @ApiModelProperty(example = "null", value = "A list of public invitation objects.")
