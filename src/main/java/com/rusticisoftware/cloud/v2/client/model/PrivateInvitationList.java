...
public class PrivateInvitationList {
  ...
  private List<PrivateInvitationSchema> invitations = new ArrayList<PrivateInvitationSchema>();
   ...
   * @return invitations
  **/
  @ApiModelProperty(example = "null", value = "A list of private invitation objects.")
